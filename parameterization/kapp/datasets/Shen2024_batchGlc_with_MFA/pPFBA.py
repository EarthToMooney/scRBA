...
if not os.path.exists('./pPFBA_kapps_RBA.txt'):
    shutil.copy('./kapps_RBA.txt', './pPFBA_kapps_RBA.txt')
...
# run RBA
os.system("cd min_flux_violation; module load gams; gams test_kapp.gms --kapp_path='../pPFBA_kapps_RBA.txt'" + output_redirect_str)
