...
# path_data = './' + os.path.basename(os.getcwd()) + '.xlsx'
...
# Including only enzyme subunits; excluding ribosome protein subunit (conflicting if fit to both enzymatic and ribosomal protein data)
